...
class HungaBungaClassifier(ClassifierMixin):
    def __init__(self, brain: object = False, test_size: object = 0.2, n_splits: object = 5, random_state: object = None, upsample: object = True,
                 scoring: object = None,
                 verbose: object = False,
                 normalize_x: object = True,
                 n_jobs: object = cpu_count() - 1,
                 grid_search: object = True) -> object:
        self.model = None
        self.brain = brain
